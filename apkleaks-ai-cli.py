...
SEVERITY_MAP = {
    ...
    "Firebase_Database_App": "high",
    "PostgreSQL_URI": "critical", "MySQL_URI": "critical",
    "MongoDB_URI": "critical", "Redis_URI": "critical",
    "JDBC_URI": "critical", "MSSQL_URI": "critical",
    "AMQP_URI": "high", "CouchDB_URI": "critical",
    "Elasticsearch_URL": "high", "Database_URL": "critical",
    "Supabase_URL": "high", "AWS_RDS_Host": "high",
    "Azure_Cosmos_Host": "high", "DB_Password_Assignment": "critical",
    ...
    "Google_Service_Account_Email": "high",
    "Firebase_Admin_SDK_Email": "critical",
    "Google_Service_Account_Private_Key": "critical",
...
EXPLANATIONS = {
    ...
    "Google_Service_Account_Email": "GCP service account email (*.iam.gserviceaccount.com). Hunt for the matching private_key JSON.",
    "Firebase_Admin_SDK_Email": "Firebase Admin SDK service account email. With a private key this is full project admin.",
    "Google_Service_Account_Private_Key": "Service-account private_key PEM inside JSON. This is an Admin SDK / GCP credential leak.",
    "Firebase_Database_App": "Firebase RTDB host (*.firebasedatabase.app). Check unauthenticated /.json read/write.",
    "PostgreSQL_URI": "PostgreSQL connection URI. Often includes user/password — full DB access if reachable.",
    "MySQL_URI": "MySQL connection URI. Often includes credentials — verify host exposure and auth.",
    "MongoDB_URI": "MongoDB / Atlas URI. Credentials in-URI are critical; test auth + network exposure.",
    "Redis_URI": "Redis URL. Unauthenticated or password-in-URI Redis is often dumpable.",
    "JDBC_URI": "JDBC database URL (MySQL/Postgres/MSSQL/Oracle). Treat as direct DB access if credentials present.",
    "MSSQL_URI": "Microsoft SQL Server connection URI. Critical when credentials are embedded.",
    "AMQP_URI": "RabbitMQ/AMQP broker URL. May expose queues/messages if reachable.",
    "CouchDB_URI": "CouchDB/Cloudant URL. Check unauthenticated HTTP API access.",
    "Elasticsearch_URL": "Elasticsearch/OpenSearch endpoint. Unauthenticated clusters often allow full dump.",
    "Database_URL": "DATABASE_URL / DB_URL assignment. Common in Heroku/.env style leaks.",
    "Supabase_URL": "Supabase project URL. Pair with anon/service_role keys for data access.",
    "AWS_RDS_Host": "AWS RDS hostname. Hunt for matching DB user/password nearby.",
    "Azure_Cosmos_Host": "Azure Cosmos DB host. Hunt for account keys / connection strings.",
    "DB_Password_Assignment": "Explicit database password assignment (db_password=...). High-value credential.",
